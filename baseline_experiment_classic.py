...
from dataset import MINCDatasetDecoded
from downstream_model import Resnet50
...
if __name__ == '__main__':
    ...
    train_minc = MINCDatasetDecoded(train=True, quality=quality)
    val_minc = MINCDatasetDecoded(train=False, quality=quality)
